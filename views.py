...
def admincourse(request):
    ...
    return render(request,"admincourse.html",{"adminuname":adminuname})
...
def updatecourse(request):
    ...
    count = Course.objects.count()
    adminuname = request.session["auname"]
    return render(request,"updatecourses.html",{"adminuname":adminuname,"coursedata":courses,"count":count})
...
def courseupdation(request,cid):
    ...
    return render(request,"courseupdation.html",{"cid":cid,"adminuname":adminuname})
...
def courseupdated(request):
    ...
    Course.objects.filter(id=courseid).update(department=dept,academicyear=Ayear,semester=semester,Year=year,coursecode=ccode,coursetitle=ctitle)
    msg= "Updated "
    return render(request,"courseupdation.html",{"msg":msg,"adminuname":adminuname})
